...
rami2d-register -mov ${moving_img} -imov h -mpp-mov 0.27 -fix ${fixed_img} -ifix 0 -mpp-fix 0.21 -o ${output_dir} -mpp-reg 1 -mpp-key 3 -a
...
rami2d-transform -i ${annotations} -mpp 0.27 -tdir ${transforms_dir} -o ${output_dir} -labels
